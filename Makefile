...
bin/compare_sorting_algorithms.exe : test/compare_sorting_algorithms.c build/bubble_sort.o build/insertion_sort.o build/merge_sort.o build/heap.o include/eval.h
	$(CC) $< $(CFLAGS) -o $@ build/bubble_sort.o build/insertion_sort.o build/merge_sort.o build/heap.o build/eval.o
