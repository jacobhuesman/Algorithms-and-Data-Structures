...
bin/compare_sorting_algorithms.exe : test/compare_sorting_algorithms.c build/bubble_sort.o build/insertion_sort.o build/merge_sort.o build/heap.o build/quick_sort.o include/eval.h
	$(CC) $< -Wl,--stack,1000000000 $(CFLAGS) -o $@ build/bubble_sort.o build/insertion_sort.o build/merge_sort.o build/heap.o build/quick_sort.o build/eval.o
